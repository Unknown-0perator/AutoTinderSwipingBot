...
chrome_driver_path = Service('YOUR CHROME DRIVER PATH')
...
login_button = driver.find_element(by=By.XPATH,
                                   value='//*[@id="content"]/div/div[1]/div/'
                                         'main/div[1]/div/div/header/div[1]/div[2]/div/button')
login_button.click()

sleep(2)
fb_login = driver.find_element(by=By.XPATH,
...
sleep(5)
allow_location_button = driver.find_element(by=By.XPATH,
                                            value='//*[@id="modal-manager"]/div/div/div/div/div[3]/button[1]')
allow_location_button.click()
notifications_button = driver.find_element(by=By.XPATH,
...
for n in range(100):
    ...
    try:
        ...
        like_button = driver.find_element(by=By.XPATH,
                                          value='//*[@id="content"]/div/div[1]/div/'
                                                'main/div[1]/div/div/div[1]/div/div[2]/div[4]/button')
        like_button.click()
    except ElementClickInterceptedException:
        try:
            match_popup = driver.find_element(by=By.CSS_SELECTOR,
                                              value=".itsAMatch a")
            match_popup.click()
